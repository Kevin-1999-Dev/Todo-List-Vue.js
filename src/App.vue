<template>
  <div id="app">
    <div class="container">
      <div class="text-white bg-secondary p-3 mb-3 text-center d-flex justify-content-between align-item-center">
        <div class="">
          <h1 class="pt-2">My ToDo List</h1>
        </div>
        <div class="text-end">
          <div class="form-check">
            <label for="flexCheckChecked" class="form-check-label">Hide Complete Tasks</label>
            <input type="checkbox" id="flexCheckChecked" class="form-check-input" v-model="hideComplete" />
          </div>
      ...
      <div class="row">
        <h3>Create Task</h3>
        <div class="col-6">
          <input type="text" class="form-control" v-model="createTask" @keyup.enter="addTask()" />
